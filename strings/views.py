...
class StringRetrieveDeleteAPIView(APIView):
    def get(self, request, value, *args, **kwargs):
        try:
            s = AnalyzedString.objects.get(value=value)
    ...
    def delete(self, request, value, *args, **kwargs):
        try:
            s = AnalyzedString.objects.get(value=value)
            s.delete()
            return Response(
                {"message": f"String '{value}' deleted"},
...
class StringNaturalLanguageFilterAPIView(APIView):
    """
    Accepts either:
      - GET /strings/filter-by-natural-language/?query=palindrome words
      - POST /strings/filter-by-natural-language/ {"query": "palindrome words"}
    """
    def get(self, request, *args, **kwargs):
        ...
        return self._filter_strings(query)
    ...
    def _filter_strings(self, query):
